...
```{r save male stacked}
ggsave(stacked_bar_male, file = "../../../preliminary_results/stackedbar_male.png", height = 6, width = 10)
```
...
ggsave(stacked_bar_female, file = "../../../preliminary_results/stackedbar_female.png", height = 6, width = 10)
```
